...
void Console::SetForegroundColor(AnsiStyle::Forecolors color) noexcept
{
#ifdef HNYPT_WINDOWS
...
void Console::SetBackgroundColor(AnsiStyle::Backcolors color) noexcept
{
#ifdef HNYPT_WINDOWS
...
void Console::Clear() noexcept
{
	...
	WinClear();
#else
	std::cout << AnsiStyle::Clear << AnsiStyle::CursorNavigation::Home;
#endif
}
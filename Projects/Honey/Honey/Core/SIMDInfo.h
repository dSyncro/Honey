...
const auto HoneyCPUID = __cpuid;
const auto HoneyXGetBV = _xgetbv;

namespace SIMDInfo {
	const bool SupportSSE = cpuinfo[3] & (1 << 25) || false;
	const bool SupportSSE2 = cpuinfo[3] & (1 << 26) || false;
	const bool SupportSSE3 = cpuinfo[2] & (1 << 0) || false;
	const bool SupportSSSE3 = cpuinfo[2] & (1 << 9) || false;
	const bool SupportSSE4_1 = cpuinfo[2] & (1 << 19) || false;
	const bool SupportSSE4_2 = sse4_2Supportted = cpuinfo[2] & (1 << 20) || false;
	const bool SupportSSE4a = false;
	const bool SupportSSE5 = false;
	const bool SupportAVX = false;
}
